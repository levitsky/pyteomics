...
As described in this `JPR article <http://dx.doi.org/10.1021/acs.jproteome.6b00144>`_,
filtering based on decoy counting is inherently biased, especially for small datasets.
All TDA-related functions have an optional argument, `correction`, that enables the correcting procedure
